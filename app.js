...
function render(){
  ...
  else if(['about','news','teaching','faculty','students','admission','disclosure','history','contact','sitemap'].includes(path)) {
    const copy={about:'<p>沪市好贤学校创办于1908年，前身为好贤义塾。学校现设小学部、初中部和高中部，拥有现代化教学设施。</p><p>近年来，学校教育教学质量稳步提升，先后获得沪市文明校园、沪市特色教育示范学校等荣誉。</p>',news:'<p>学校新闻按发布时间归档。请通过首页查看最新校园动态。</p>',teaching:'<p>学校坚持五育并举，开齐开足国家课程，持续推进课堂教学改革。</p>',faculty:'<p>学校现有专任教师186人，其中高级教师42人，市、区级骨干教师35人。</p>',students:'<p>本栏目展示学生成长、班级风采与校园活动。</p><p><a href="#students/class2020" data-route>历届班级 · 2020届初三年级</a></p>',admission:'<p>有关招生计划、课程设置及校园开放安排，请以学校招生办公室发布的信息为准。</p>',disclosure:'<p>本栏目依法公开学校基本信息、收费项目、招生事项和校务工作。</p>',history:'<p>好贤学校前身为好贤义塾。校史资料正在持续数字化整理中。</p>',contact:'<p>地址：沪市静安区文河路218号。电话：021-6588 2048。</p>',sitemap:'<p>学校首页　学校概况　新闻中心　教育教学　师资队伍　学生天地　招生信息　校务公开　校史馆　资料下载</p>'}; const titles={about:'学校概况',news:'新闻中心',teaching:'教育教学',faculty:'师资队伍',students:'学生天地',admission:'招生信息',disclosure:'校务公开',history:'校史馆',contact:'联系我们',sitemap:'网站地图'}; html=simplePage(titles[path],copy[path]);
